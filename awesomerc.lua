...
globalkeys = gears.table.join(
    -- TOM CHANGE BEGIN (add media keys)
    -- NOTE: This requires that `playerctl` has been installed.
    ...
    -- This requires that `maim` and `xclip` have been installed.
    --  It takes a screenshot of the snippet that the user selects, and puts it onto the X11 clipboard.
    awful.key({ modkey, "Shift" }, "s", function () awful.util.spawn_with_shell("maim -s | xclip -selection clipboard -t image/png") end),
    -- TOM CHANGE END
...
awful.rules.rules = {
    ...
    { rule_any = {type = { "normal", "dialog" }
      }, properties = { titlebars_enabled = false }  -- TOM CHANGE disable titlebars
    },
