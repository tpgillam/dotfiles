-- NOTE: leaving this commented out in case it is useful when revisiting rust config.
--  This plugin is deprecated in favour of:
--      - native rust-analyzer client
--      - https://github.com/mrcjkb/rustaceanvim
--  I've removed it since it uses now-deprecated API from elsewhere, causing noise.
return {
